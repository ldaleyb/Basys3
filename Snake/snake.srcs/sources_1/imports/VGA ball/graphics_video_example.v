...
output wire [6:0]seg2;
	...
	wire update;
	ball col(snakeBody,snakeHead,border,game_over,VGA_clk,update,start,xCount,yCount,x,y,z,w,h,apple,seg1,seg2);
	vga_sync VGA(VGA_clk, xCount, yCount, displayArea, VGA_hSync, VGA_vSync, blank_n);
	random_apple CLKs(master_clk, update,VGA_clk);
